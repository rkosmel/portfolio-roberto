...
Atuei em projetos como Blue Exams, The Mindville e MBA No Brainer, trabalhando com React/Next.js, Node.js (Express) e PostgreSQL/Prisma, além de autenticação (NextAuth), assinaturas (Stripe) e operação em AWS (EC2/RDS/S3), Linux/Nginx e Docker.
